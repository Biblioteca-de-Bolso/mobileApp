...
class AddAnnotationContentViewModel : ViewModel() {
    ...
    fun saveAnnotation(accessToken: String, bookId: Int, title: String, text: String, page: Int = 0) {
        viewModelScope.launch {
            val result = AnnotationDataSource.saveAnnotation(accessToken, bookId, title, text, page)
